...
namespace csharp_real_estate.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            List<ProductViewModels> HotProducts = new List<ProductViewModels>();
            List<ProductViewModels> NewProducts = new List<ProductViewModels>();
            List<ProductViewModels> TrendProducts = new List<ProductViewModels>();
            string thumb;
            ...
            foreach (var item in HotProduct)
            {
                ...
                HotProducts.Add(new ProductViewModels(item, thumb));
            }
            ...
            foreach (var item in NewProduct)
            {
                ...
                NewProducts.Add(new ProductViewModels(item, thumb));
            }
            ...
            foreach (var item in TrendProduct)
            {
                ...
                TrendProducts.Add(new ProductViewModels(item, thumb));
            }
